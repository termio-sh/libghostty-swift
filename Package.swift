...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.1.2/GhosttyKit.xcframework.zip",
            checksum: "72405d53e9a4c5865043d570d00b75a13fe6776c64418c98604b093470491119"
        ),
        .testTarget(
            name: "GhosttyKitTest",
