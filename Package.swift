...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.1.1/GhosttyKit.xcframework.zip",
            checksum: "dd1866edc1dcf048397d7d01d1e362335d1e3e5b3edca14e298cad6b224465c6"
        ),
        .testTarget(
            name: "GhosttyKitTest",
