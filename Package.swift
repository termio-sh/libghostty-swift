...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.0.23/GhosttyKit.xcframework.zip",
            checksum: "c61b2061dff039a3678c9eac11c31d45903655966f5dd8c6dba28295822a3566"
        ),
        .testTarget(
            name: "GhosttyKitTest",
