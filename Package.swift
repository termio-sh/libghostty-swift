...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.0.22/GhosttyKit.xcframework.zip",
            checksum: "aab68945f5484c6d6d383a007be99aefece73b84bf3d3e8a2d36c5afc8d7df7c"
        ),
        .testTarget(
            name: "GhosttyKitTest",
