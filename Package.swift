...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.0.19/GhosttyKit.xcframework.zip",
            checksum: "8e1d289be31c1fe377cd21bbb4eb2b76c38290aabfbcbcb206fd8271382afe2b"
        ),
        .testTarget(
            name: "GhosttyKitTest",
